        ...
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <View style={styles.headingtext}>
              <TouchableOpacity onPress={() => setArchive(true)}>
                <Image
                  source={AppImages.archive}
                  style={{width: 24, height: 24}}
                />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setProduct(true)}>
                <Image
                  ...
                  renderItem={({item}) => {
                    return (
                      <View>
                        <TouchableOpacity
                          onPress={() => {
                            navigation.navigate('NetworkProblem');
                          }}>
                          <Image
                            source={item.img}
          ...
          <View style={styles.description}>
            ...
            <Text style={styles.descriptiontxt}>
              Lorem ipsum dolor sit amet consectetur. Enim aenean id elit sit
              vel at tempor dignissim imperdiet. Turpis enim sed dui justo sit
              ac enim.
            </Text>
          </View>
          ...
          {/* start archive modal */}
          <Modal isVisible={archive}>
            <View style={styles.archivevieww}>
              <View style={styles.archiveChatt}>
                <Image
                  source={AppImages.archive}
                  style={styles.archiveChattimg}
                />
                <Text style={styles.archiveChattheading}>
                  Archive this item
                </Text>
                <Text style={styles.archiveChatttext}>
          ...
          {/* start change modal */}
          <Modal isVisible={change}>
            <View style={styles.productvieww}>
              <View style={styles.blockChatt}>
                <Image
                  source={AppImages.tickbadge}
                  style={styles.changeChattimg}
                />
                <Text style={styles.blockChattheading}>Changes Saved</Text>
                <Text style={styles.blockChatttext}>
                  Great, your changes have been saved successfully, Thanks.
                </Text>
              </View>
