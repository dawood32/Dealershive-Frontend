        ...
        <ScrollView style={{ flex: 1 }}>
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <View style={styles.headingtext}><TouchableOpacity onPress={() => { navigation.navigate('EditProduct') }} ><Text style={styles.heading1}>Clear all</Text></TouchableOpacity></View>
                </View>

                <View style={styles.productview}>
                    <View style={styles.productstyle}>
                        <View style={styles.productbg}>
                            <View style={styles.productimage}><TouchableOpacity><Image source={AppImages.closecircle} style={{ width: 12, height: 12, }} /></TouchableOpacity></View>
                           <TouchableOpacity onPress={() => { navigation.navigate('ProductDetailScreen') }} ><Image source={AppImages.productimageshadow} style={{ width: 129, height: 147 }} /></TouchableOpacity> 
                        </View>
                ...
                <View style={{ alignItems: 'center' }}>
                    <TouchableOpacity style={styles.button} onPress={() => setProduct(true)}>
                ...
                <Modal
                    ...
                    <View style={styles.productvieww}>
                        <View style={styles.blockChatt}>
                            <Image source={AppImages.tickbadge} style={styles.blockChattimg} />
                            <Text style={styles.blockChattheading}>Product Added Successfully</Text>
                            <Text style={styles.blockChatttext}>You're welcome! If you have any more questions or need further assistance, feel free to ask. Enjoy using your new product!</Text>
                        </View>
                        <View style={styles.modalView}>
                            <TouchableOpacity onPress={() => setProduct(false)} style={styles.modalView1}>
                                <View style={styles.modalbtn}>
                                    <Text style={styles.modaltxt}>Go to home</Text>
                                    <Image source={AppImages.ar} style={{ width: 24, height: 24 }} />
                                </View>
                            </TouchableOpacity>
